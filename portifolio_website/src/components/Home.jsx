  ...
  <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-blue-900">
    <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="text-white">
          ...
          <div className="mb-8">
            <h1 className="text-4xl lg:text-6xl font-bold leading-tight mb-8">
              Hello, I'm<br />
              <span className="text-blue-400">Shedrack Siame</span><br />
              A Computer Engineer
            </h1>
            <button 
              onClick={() => setCurrentPage('project')}
              className="bg-blue-600 hover:bg-blue-700 px-8 py-3 rounded-lg flex items-center gap-2 transition-colors duration-300"
            >
              <Eye size={20} />
              Browse All Projects
            </button>
      ...
      <div className="text-center mb-20">
        <div className="text-white">
          <p className="text-blue-400 text-lg mb-4">What I can Offer</p>
          ...
          <button 
            ...
            className="bg-transparent border-2 border-blue-400 text-blue-400 hover:bg-blue-400 hover:text-white px-8 py-3 rounded-lg transition-all duration-300"
          >
      ...
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="text-white">
          <p className="text-blue-400 text-lg mb-4">About me</p>
